...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/encode/uvicorn/main/docs/img/gh-actions-fail.png" alt='Failing PR commit status'>
</p>
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/encode/uvicorn/main/docs/img/gh-actions-fail-check.png" alt='Failing GitHub action lint job'>
</p>
...
- **An update to the changelog**:
    ...
    - [Compare](https://github.com/encode/uvicorn/compare/) `main` with the tag of the latest release, and list all entries that are of interest to our users:
